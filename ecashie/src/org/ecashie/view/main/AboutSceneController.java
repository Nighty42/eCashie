...
import org.ecashie.controller.utilities.GeneralOperations;
import org.ecashie.controller.utilities.HyperlinkUtils;
import org.ecashie.model.appdetails.AppDetails;
import org.ecashie.model.appdetails.AppVersion;
import org.ecashie.model.appdetails.Contributor;
import org.ecashie.model.appdetails.ImageSource;
			...
			public TableCell<ImageSource, String> call(TableColumn<ImageSource, String> param)
			{
				...
				TableCell<ImageSource, String> tableCell = new TableCell<ImageSource, String>()
				{
					...
					public void updateItem(String item, boolean empty)
					{
						...
						{
							imageView
									.setImage(new Image(MainApp.class.getResourceAsStream("resources/images/" + item)));
						}
					}
				};
